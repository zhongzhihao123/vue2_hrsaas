    ...
    <div class="app-container">
      <page-tools :show-before="true">
        ...
        <template #after>
          ...
          <el-button :disabled="!checkPermission('add-user')" size="small" type="primary" @click="showDialog = true">新增员工</el-button>
        </template>
        ...
        <el-table v-loading="loading" :data="list" border stripe>
          ...
          <el-table-column label="操作" sortable="" fixed="right" width="280">
            <template v-slot="{ row }">
              ...
              <el-button :disabled="!checkPermission('del-user')" type="text" size="small" @click="delEmployee(row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 分页 -->
